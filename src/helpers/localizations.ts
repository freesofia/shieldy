export const localizations = {
  ...
  digits_warning: {
    ...
    bg:
      ', Моля, изпратете решението на аритметичната задачка, която виждате тук в рамките на времето посочено от мен, в противен случай ще бъдете изхвърлени от групата. Благодаря ви!',
  },
  button_warning: {
    en:
